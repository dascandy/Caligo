...
TEST_CASE("hkdf single test vector", "[HKDF]") {
  ...
  std::array<uint8_t, SHA2<256>::hashsize> handshake_secret = { 0xfb, 0x9f, 0xc8, 0x06, 0x89, 0xb3, 0xa5, 0xd0, 0x2c, 0x33, 0x24, 0x3b, 0xf6, 0x9a, 0x1b, 0x1b, 0x20, 0x70, 0x55, 0x88, 0xa7, 0x94, 0x30, 0x4a, 0x6e, 0x71, 0x20, 0x15, 0x5e, 0xdf, 0x14, 0x9a };

  auto hs = HKDF_HandshakeSecret<SHA2<256>>(shared);
  ...
  std::vector c_tr = HKDF_Expand_Label<SHA2<256>>(handshake_secret, "c hs traffic", helloHash, 32);
  ...
  std::vector s_tr = HKDF_Expand_Label<SHA2<256>>(handshake_secret, "s hs traffic", helloHash, 32);
  ...
  auto ms = HKDF_MasterSecret<SHA2<256>>(hs);
...
TEST_CASE("hkdf finished calculation (Client)", "[HKDF]") {
  ...
  SHA2<256> hashObj(messages);
  std::array<uint8_t, SHA2<256>::hashsize> serverFinHash = hashObj;
  ...
  auto s_fin_key = HKDF_Expand_Label<SHA2<256>>(sht_secret, "finished", {}, 32);
  std::array<uint8_t, SHA2<256>::hashsize> shash = HMAC<SHA2<256>>(serverFinHash, s_fin_key);
  std::array<uint8_t, SHA2<256>::hashsize> serverDigest = { 0xea, 0x6e, 0xe1, 0x76, 0xdc, 0xcc, 0x4a, 0xf1, 0x85, 0x9e, 0x9e, 0x4e, 0x93, 0xf7, 0x97, 0xea, 0xc9, 0xa7, 0x8c, 0xe4, 0x39, 0x30, 0x1e, 0x35, 0x27, 0x5a, 0xd4, 0x3f, 0x3c, 0xdd, 0xbd, 0xe3 };
  ...
  std::array<uint8_t, SHA2<256>::hashsize> fin_hash = { 0x22, 0x84, 0x4b, 0x93, 0x0e, 0x5e, 0x0a, 0x59, 0xa0, 0x9d, 0x5a, 0xc3, 0x5f, 0xc0, 0x32, 0xfc, 0x91, 0x16, 0x3b, 0x19, 0x38, 0x74, 0xa2, 0x65, 0x23, 0x6e, 0x56, 0x80, 0x77, 0x37, 0x8d, 0x8b };
  std::array<uint8_t, SHA2<256>::hashsize> clientFinHash = hashObj;
  auto fin_key = HKDF_Expand_Label<SHA2<256>>(cht_secret, "finished", {}, 32);
  std::array<uint8_t, SHA2<256>::hashsize> hash = HMAC<SHA2<256>>(fin_hash, fin_key);
  std::array<uint8_t, SHA2<256>::hashsize> digest = { 0x97, 0x60, 0x17, 0xa7, 0x7a, 0xe4, 0x7f, 0x16, 0x58, 0xe2, 0x8f, 0x70, 0x85, 0xfe, 0x37, 0xd1, 0x49, 0xd1, 0xe9, 0xc9, 0x1f, 0x56, 0xe1, 0xae, 0xbb, 0xe0, 0xc6, 0xbb, 0x05, 0x4b, 0xd9, 0x2b };
